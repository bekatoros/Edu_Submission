...
if((user.getRole()==1)&&(!sub_id.equals("0")))//erxetai apo to edit_submission
{
       ...
       rs = statement.executeQuery("SELECT * FROM ee_Publication where  '"+sub_id +"'=sub_id;");
       if(rs.next())
       {
   ...
   //perno to sub_id
    ...
    //erothma sth vash gia item_id
       rs2 = statement.executeQuery("SELECT * FROM ee_Publication where  sub_id="+sub_id+";");
      //out.println("mphka");
        String id="";
        if (rs2.next()){
                            ...
                            { 
                                if(user.getRole()==1)
                                {
                                  ...
                                  // sub_id=0;
                                            String item_id="";
                                            statement = connection.createStatement();
                                            rs = statement.executeQuery("SELECT * FROM ee_Publication WHERE status="+finalstate+" AND user_id="+user.getId());                                           
