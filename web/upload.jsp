...
<%
           ...
           if (rs2.next()){
              ...
              //  int updateresult = statement.executeUpdate("Update Submission SET bit_id = "+bitid+" WHERE sub_id ="+sub_id+" LIMIT 1 ;");  
                int res=statement.executeUpdate("UPDATE ee_Publication SET bit_id = '"+bitid+"' WHERE sub_id ='"+sub_id+"' LIMIT 1 ;");
               int res2=statement.executeUpdate("UPDATE ee_Publication SET status = '"+finalstate+"' WHERE sub_id ='"+sub_id+"' LIMIT 1 ;");
